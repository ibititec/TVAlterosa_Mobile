package com.ibititec.tvalterosa.modelo;
...
public class Bolao implements Serializable {
    ...
    public com.ibititec.tvalterosa.modelo.Usuario getUsuario() {
        return Usuario;
    }

    public void setUsuario(com.ibititec.tvalterosa.modelo.Usuario usuario) {
        Usuario = usuario;
    }

    public com.ibititec.tvalterosa.modelo.Partida getPartida() {
        return Partida;
    }

    public void setPartida(com.ibititec.tvalterosa.modelo.Partida partida) {
        Partida = partida;
    }
